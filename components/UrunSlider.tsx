...
const SLAYTLAR: Slayt[] = [
  ...
  {
    etiket: "Mitsubishi Electric · City Multi",
    baslik: "City Multi VRF Sistemleri",
    alt: "Mitsubishi Electric City Multi VRF dış üniteleri",
    href: "/urunler",
  ...
  {
    etiket: "TCL · Mini VRF",
    baslik: "Tam DC İnverter Mini VRF",
    alt: "TCL Mini VRF dış üniteleri",
    href: "/urunler",
    gorsel: "/slider/slider-tcl-mini-vrf.jpg",
  },
  {
    etiket: "TCL · İç Ünite Gamı",
    baslik: "Kaset Tipi İç Üniteler",
    alt: "Tavana monte TCL kaset tipi iç ünite",
    href: "/urunler",
