  ...
  return (
    <div className="max-w-3xl">
      ...
      <form action={sirketAyarlariGuncelle} className="bg-yuzey border border-hat rounded-lg p-6 space-y-4">
        ...
        <div className="border-t border-hat pt-4">
          <label className="block text-xs font-semibold text-metin/70 mb-1">WhatsApp Numarası (sitede buton olarak görünür)</label>
          <input
            name="whatsapp"
            defaultValue={sirket.whatsapp ?? ""}
            placeholder="Örn: 0532 123 45 67 — boş bırakılırsa WhatsApp butonu çıkmaz"
            className="focus-ring w-full sm:w-1/2 border border-hat rounded-md px-3 py-2 text-sm bg-white"
          />
        </div>
